...
`SOLUTION_JSON_REPAIR_PASS=1` lets the worker ask the model to repair invalid JSON once. Raw/repaired model outputs are saved under `solutions/<contest_id>/debug/` when parsing fails.
